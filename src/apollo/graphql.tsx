 ...
 * });
 */
export function useShipsQuery(baseOptions: ApolloReactHooks.QueryHookOptions<ShipsQuery, ShipsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<ShipsQuery, ShipsQueryVariables>(ShipsDocument, options);
      }
export function useShipsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ShipsQuery, ShipsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<ShipsQuery, ShipsQueryVariables>(ShipsDocument, options);
        }
...
export type ShipsQueryResult = ApolloReactCommon.QueryResult<ShipsQuery, ShipsQueryVariables>;